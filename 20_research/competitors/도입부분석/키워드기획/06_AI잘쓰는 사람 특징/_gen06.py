# -*- coding: utf-8 -*-
# Self-contained generator for keyword 06 (AI 잘쓰는 사람 특징).
# No external gen-module imports. Writes ONLY new files into the 06 folder. SOP-compliant.
import os, html

ROOT = "/sessions/loving-eloquent-goldberg/mnt/도입부분석/키워드기획/06_AI잘쓰는 사람 특징"
...
def bar_cls(pct):
    return 'b-ok' if pct>=70 else ('b-warn' if pct>=50 else 'b-bad')
...
%(raw)s
  ...
  <footer>키워드 기획 분석 · 2026-06-13 · 기준 <a href="../../../작업지침서.md">작업지침서</a> · <a href="../../../도입부분석_통합지침_(코워크용).md">통합지침</a><br>출처: <a href="%(url)s">YouTube — %(ch)s</a> · 내부 기획·학습용</footer>
</div>
<script>
%(js)s
</script>
